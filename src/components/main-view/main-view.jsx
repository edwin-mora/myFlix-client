...
export class MainView extends React.Component {
    ...
    constructor(){
        ...
        this.state = {
            movies: [
                { _id: 1, Title: 'Inception', Descripton: 'desc1', ImagePath: '...'},
                { _id: 2, Title: 'The Shawshank Redemption', Descripton: 'desc2', ImagePath: '...'},
                { _id: 3, Title: 'Gladiator', Descripton: "text text", ImagePath: '...'}
            ], 
            selectedMovie: null
        };
    }
